...
/**
 * Генератор поля ввода корпоративной эл. почты
 */
class CorporateEmailFieldRenderer implements FormElementRendererInterface
{
    private User $user;
    ...
    public function render(array $specification): string
    {
        ...
        $_specification['value'] = $this->user->userProfile->email;
